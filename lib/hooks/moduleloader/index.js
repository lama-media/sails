module.exports = function(sails) {
  ...
  return {
    ...
    loadModels: function (cb) {
      ...
      includeAll.optional({
        dirname   : path.join( process.cwd(), 'node_modules', 'sails-hook-panel-base', 'api', 'models'),
        filter    : /^(.+)\.(?:(?!md|txt).)+$/,
        replaceExpr : /^.*\//,
        flatten: true
      }, function(err, models2) {
        ...
        includeAll.optional({
          ...
          includeAll.optional({
            ...
            console.log('models imported', models['user'].afterCreate)
